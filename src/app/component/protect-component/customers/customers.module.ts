...
@NgModule({
  declarations: [ CustomerComponent, AccountsComponent, SummaryComponent, AssetsComponent, LiabilitiesComponent, InsuranceComponent, IncomeComponent, ExpensesComponent, CustomerDocumentsComponent],
  imports: [
    CommonModule,
